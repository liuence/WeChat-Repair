...
<li data-role="list-divider" data-ajax="false"> 申报 <span style="float:right"><?php echo $time;?></span</li> 
	<li> 
		...
		<p>手机：<a href="tel:<?php echo $tel;?>" style="text-decoration : none "/><?php echo $tel;?></a></p> 
...
<center> <a href="review.php?id=<?php echo $id;?>" data-ajax="false" data-theme="c" data-role="button" data-inline="true" data-icon="edit"> 处理业务</a> </center>
   </div>
