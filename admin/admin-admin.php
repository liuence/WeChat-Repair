...
<div id="container">
  ...
  <b><?php include("header.php") ?>|欢迎您,点击此处 <a href="admin-admin.php?action=logout">注销</a> 登录！ </b>  
    <form action="" method="post" enctype="multipart/form-data" name="form" id="form" onsubmit="CheckPost();">
  <fieldset>
  <legend>新增管理员账号</legend>
...
$sql = "INSERT  INTO `admin` ( `id` ,`name` ,`password` , `role`) VALUES ('', '$name' ,'$password' ,'$role') ";    
