...
<div id="container">
  ...
  <legend>账号信息管理</legend>
    <dl id="id" class="title">
   <dt>ID</dt>
   <dd><input name="id" value="<?php echo $id;?>" type="text" /></dd>
</dl>   
...
$id2=$_POST['id']; 
$sql="UPDATE `worker` set `id`='".$id2."',`name`='".$name."',`role`='".$role."', `openid`='".$openid."', `tel`='".$tel."', `password`='".$password."'where id='".$id."'";
