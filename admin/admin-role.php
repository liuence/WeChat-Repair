...
<?php
   ...
   require_once("../db.php");  
   $sql2 = "SELECT * FROM `admin` order by `id` desc limit $page $pagesize ";
...
<?php foreach(  $arr2 as $item ): ?>  
            <tr>
    		 ...
    		 <td><a href="edit-admin.php?id=<?php echo $item['id'];?>">编辑</a></td>
    		 <td><a href="del-admin.php?id=<?php echo $item['id'];?>">删除</a></td>
           </tr>
 <?php endforeach; ?>
	<?php endif; ?>
    </table>
